...
//        String sql="insert into Return(StudentID,Name,FName,Course,Branch,Year,Semester,BookID,BName,Edition,Publisher,Price,Pages,DOI,DOR) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         String sql="insert into return1(StudentID,Name,FName,Course,Branch,Year,Semester,BookID,BName,Edition,Publisher,Price,Pages,DOI,DOR) Values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
            pst=conn.prepareStatement(sql);
            pst.setString(1,jTextField1.getText());
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/magnifier.png"))); // NOI18N
        ...
        setSize(new java.awt.Dimension(772, 493));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            if(rs.next())
            {
                ...
                JOptionPane.showMessageDialog(null,"Book is not Issued whith this Student ID");
            }
        }catch(Exception e){
            JOptionPane.showMessageDialog(null, e);
        }finally{
